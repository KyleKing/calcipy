...
- calcipy/doit_tasks/lint.py
    - line  61   FIXME: Docstrings should be reporting an error here for mismatch in types
    - line 160 PLANNED: Simplify and choose one way of using Radon
    - line 183     FYI: `IT` could be useful to handle deprecation. For now, only run the default checkers: https://pypi.org/project/it
