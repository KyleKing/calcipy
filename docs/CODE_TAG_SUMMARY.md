...
- appveyor.yml
    - line  80 PLANNED: Specify single files, like wheels, but zip the docs/reports
...
- calcipy/doit_tasks/packaging.py
    - line 129 PLANNED: Check that this prevent excess requests to PyPi and refactor
    - line 254     TBD: Handle non-pypi domains and format the URL accordingly (i.e. TestPyPi, etc.)
...
Found code tags for FIXME (3), TODO (12), PLANNED (7), HACK (1), TBD (1)
