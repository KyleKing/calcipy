...
> https://iscinumpy.dev/post/bound-version-constraints/#tldr This script is useful for raising the floor, which helps
reduce the load on a dependency resolver by reducing the possible number of combinations to consider
