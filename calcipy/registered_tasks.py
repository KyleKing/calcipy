"""Registered tasks. Import to a dodo.py file with the below snippet.
...
from .doit_helpers.doc import (task_document,  # noqa: F401 lgtm [py/unused-import]
                               task_open_docs, task_tag_create, task_tag_remove, task_update_cl)
