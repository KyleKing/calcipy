...
def _search_files(paths_file: Sequence[Path], regex_compiled: Pattern[str]) -> List[_Tags]:
...
def _write_code_tag_file(path_tag_summary: Path) -> None:
    ...
    matches = _search_files(_find_files(), regex_compiled)  # FIXME: replace find_files() with DIG.*.something?
