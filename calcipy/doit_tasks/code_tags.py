...
def task_collect_code_tags() -> DoitTask:
    ...
    user_files = [pth for pth in get_dg().meta.paths if not get_relative(pth, get_dg().doc.auto_doc_path)]
    kwargs = {
        'path_tag_summary': get_dg().tags.path_code_tag_summary,
        'paths_source': user_files,
        'base_dir': get_dg().meta.path_project,
        'regex_compiled': get_dg().tags.compile_issue_regex(),
        'header': f'# Task Summary\n\nAuto-Generated by `calcipy`',
        'tag_order': get_dg().tags.tags,
    }
